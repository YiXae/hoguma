							...
							<div class="my_detail_zone_box">
								...
								<div class="detail_ilji">
									<table class="detail_ilji_table">
										...
										<tr>
											<td class="detail_ilji_td_back"><strong>생산물 :</strong> ${boardview.bmainproduct} > ${boardview.bproduct}</td>
										</tr>
										<tr>
								...
								<div id="detail_contents" class="detail_style">
									...
									<div class="liked">
										<button type="button" id="likebutton" class="btn_like">
											<span class="img_emoti">좋아요</span>
											<span class="ani_heart_m"></span>
										</button>	
										<div class="good_text_ct">${boardview.bgoodcnt}</div>									
									</div>									
								...
								<div id="border3">
									...
									<div class="buttonleft">
										<button onClick="history.go(-1); return false;" class="go_list_btn">목록으로</button>
									...
									<div class="buttonright">
										<c:if test="${sessionScope.loginUser.mnick == boardview.bwriter}">
											...
											<button id="del_board" class="del_btn">삭제 버튼</button>
									    </c:if>								
									</div>
								</div>
							</div>
