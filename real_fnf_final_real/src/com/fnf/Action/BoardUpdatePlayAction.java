...
public class BoardUpdatePlayAction implements Action{
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response)
		...
		int bno = Integer.parseInt(multi.getParameter("bbno"));
		...
		String bitem = multi.getParameter("item_sel_again");
		String bitema = multi.getParameter("item_sel");
	...
	//					 multi.getOriginalFileName(file1); //그냥 오리지널 파일이름
		...
		bDto = new BoardDTO(bno, btitle, bopen, bitem, bitema, bkind, bmainproduct, bproduct, btotalproduct, bpbirth, bprice, bsplace, bcontent, bwriter, bpplace, bfilename, bfilesize); //파일자체가 들어가는게 아니라 이름만 들어가있는 거임 
