...
/* String path = "D:/04. Developer/eclipse/html_workspace/fnf/WebContent/smarteditor/Webserver_imgup/";*/

String path = request.getSession().getServletContext().getRealPath("/") + File.separator + "/smarteditor/Webserver_imgup/"; 

/* String path = "D:/Web_design/fnf/WebContent/smarteditor/Webserver_imgup/"; */ 
