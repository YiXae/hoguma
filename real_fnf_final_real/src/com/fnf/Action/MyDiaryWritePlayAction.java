...
public class MyDiaryWritePlayAction implements Action {
	...
	public ActionForward excute(HttpServletRequest request, HttpServletResponse response)
		...
		BoardDTO bDto = new BoardDTO(btitle, bopen, bitem, bitema, bkind, bmainproduct, bproduct, btotalproduct, bpbirth, bprice, bsplace, bcontent, bwriter, bpplace, bfilename, bfilesize); //파일자체가 들어가는게 아니라 이름만 들어가있는 거임 		
