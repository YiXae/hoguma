...
public class BoardDTO {
	...
	public BoardDTO(int bno, String btitle, String bopen, String bitem, String bkind, String bmainproduct,
	...
	public BoardDTO(String btitle, String bopen, String bitem, String bkind, String bmainproduct, String bproduct,
	...
	public String toString() {
		return "BoardDTO [bno=" + bno + ", btitle=" + btitle + ", bopen=" + bopen + ", bitem=" + bitem + ", bkind="
				+ bkind + ", bmainproduct=" + bmainproduct + ", bproduct=" + bproduct + ", btotalproduct="
				+ btotalproduct + ", bpbirth=" + bpbirth + ", bprice=" + bprice + ", bsplace=" + bsplace + ", bcontent="
				+ bcontent + ", bwriter=" + bwriter + ", bpplace=" + bpplace + ", bregdate=" + bregdate + ", bviewcnt="
				+ bviewcnt + ", breplycnt=" + breplycnt + ", bgoodcnt=" + bgoodcnt + ", bfilename=" + bfilename
				+ ", bfilesize=" + bfilesize + "]";
	}
