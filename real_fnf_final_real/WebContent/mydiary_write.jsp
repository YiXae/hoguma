							...
							<form id="frm_boardwrite" name="frm_boardwrite" action="boardinsertplay.bizpoll" method="POST" enctype="multipart/form-data">
								<div class="detail_ilji">
									<table class="write_ilji_table">
										<tr>
											...
											<td class="write_ilji_table_td2">: 
												...
												<input type="text" id="write_title_p" name="write_title_p" placeholder="제목 입력" class="formstyle_write2">
											</td>
										</tr>
									</table>									
										...
										<table class="write_ilji_table">
											<tr>
												...
												<td class="write_ilji_table_td2">																											
													...
													<div class="write_td_div3">
														<input type="text" id="totalproduct" name="totalproduct" placeholder="생산량을 kg단위로 입력해 주세요." class="formstyle_write1"> kg											
													</div>
													<div class="writer_error">
														필수정보 입니다.															
													</div>	
													...
													<div class="write_td_div3">
														<input type="text" id="productbrith" name="productbrith" placeholder="생산일을 입력해 주세요." class="formstyle_write1"> 예) 20180101											
													</div>
													<div class="writer_error">
														필수정보 입니다.															
													</div>												
													...
													<div class="write_td_div3">
														<input type="text" id="productprice" name="productprice" placeholder="판매가격을 입력해 주세요." class="formstyle_write1"> 만원													
													</div>
													<div class="writer_error">
														필수정보 입니다.															
													</div>
													...
													<div class="write_td_div4">
														<input type="text" id="productsaler" name="productsaler" placeholder="판매처를 입력해 주세요." maxlength="20" class="formstyle_write1">													
													</div>
													<div class="writer_error">
														필수정보 입니다.															
													</div>			
									...
									<div class="write_ilji_table_td5" id="text_width">											
										<textarea id="textAreaContent" name="textAreaContent" class="formstyle_write2"></textarea>										
									...
									<table class="write_ilji_table">
										<tr>
											<td class="write_file_td"> 												
												...
												<span class="file" id="file-name" style="height:20px; border:none;">선택된 파일 없음 </span>
...
<!-- 스크립트 시작 -->
<script type="text/javascript" src="js/mydiary_write.js"></script>
